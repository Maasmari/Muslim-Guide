...
import 'package:muslim_guide/Widgets/Tasks/performance_task_item.dart';
import 'package:provider/provider.dart';
import 'package:muslim_guide/models/task.dart';
import 'package:muslim_guide/providers/task_provider.dart';

// ignore: must_be_immutable
class PerformanceTasksList extends StatelessWidget {
  PerformanceTasksList({
    super.key,
    required this.tasks,
    required this.now,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, index) => Dismissible(
        ...
        direction: DismissDirection.none, // Only allow swiping in one direction
